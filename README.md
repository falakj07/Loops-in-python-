...
The aim of this project is to study and learn about  looping statements in Python such as **while loop**, **for loop**, and the use of the **range() function**.  

This  helps in understanding how repetition works in programming and how loops help in reducing code redundancy by executing a block of code multiple times.
...
It is a control structure that allows repeated execution of a block of code as long as a specified condition is true.
...
* Infinite loop risk
* Difficult to debug if condition incorrect
